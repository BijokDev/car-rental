...
- **2026-06-23T11:00:00+08:00:** Complete site rebrand to "TRAVTHRU" (from AJ Taxi KL), Address updated to Lot 302 Pertama Complex, Jalan Tuanku Abdul Rahman, Chow Kit. Booking Form restructured to support "Transfer" vs "By the Hour" flows. Perfect 100/100 SEO implemented with automated sitemap generation (`generate-sitemap.js`) and automated `.webp` image optimization.
